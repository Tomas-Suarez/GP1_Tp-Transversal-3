...
public class main extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        VistaInscripcion.setText("Inscripcion");
        VistaInscripcion.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                VistaInscripcionActionPerformed(evt);
            }
        });
        jMenu2.add(VistaInscripcion);

        jMenuItem4.setText("Cargar Notas");
        jMenu2.add(jMenuItem4);

        jMenuItem5.setText("Lista inscripciones");
    ...
    private void VistaInscripcionActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_VistaInscripcionActionPerformed
        ...
        Escritorio.repaint();
        VistaInscripcion JFinscripcion = new VistaInscripcion();
        JFinscripcion.setVisible(true);
        Escritorio.add(JFinscripcion);
        Escritorio.moveToFront(JFinscripcion);
